  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-between gap-y-20 xl:flex-row-reverse">
        <div className="flex items-center justify-center rounded-[64px] bg-white max-xl:mx-auto xl:ml-auto xl:h-[555px]">
          <Image
            src="/me.png"
            alt="My Memoji"
            width={420}
        ...
        <div className="w-full space-y-10 lg:space-y-20 xl:w-[55%]">
          <Text />
          <Button />
        </div>
      </div>
