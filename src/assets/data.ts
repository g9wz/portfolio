export const projects = [
  {
    ...
    title: "Erbut",
    description:
      "Co-founded a link-in-bio tool. Built with Go, gRPC, PostgreSQL, React, Zustand, and Tailwind CSS. Self-hosted via Coolify as a microservices architecture.",
  },
  {
    url: "https://sarnd.sa/",
    ...
    title: "Sarnd",
    description:
      "Designed, built, and deployed from scratch using Next.js and Tailwind CSS. Met strict client requirements, including specific text lengths and provided images.",
  },
  {
