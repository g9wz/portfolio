export const projects = [
  ...
  },
  {
    ...
    alt: "Animated GIF of the website landing page, showcasing the hero section with a background video and a brief company description.",
    title: "Sarnd",
    description:
      "My first freelance project! Designed, built, and deployed the entire website from scratch using Next.js and Tailwind CSS, integrating it with a CMS. Met strict client requirements, including specific text lengths and provided images.",
  },
  {
